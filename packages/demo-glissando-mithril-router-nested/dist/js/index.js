...
/***/ "../../glissando-helpers/dist/glissando-helpers.module.js":
/*!****************************************************************!*\
  !*** ../../glissando-helpers/dist/glissando-helpers.module.js ***!
  \****************************************************************/
...
/* harmony export */   "createLocationsFromPath": function() { return /* binding */ createLocationsFromPath; }
/* harmony export */ });
...
var pathToTrail = function pathToTrail(path) {
  ...
  return path.split(prefix).filter(Boolean).map(function (fragment) {
    return "".concat(prefix).concat(fragment);
  }).reduce(function (acc, fragment) {
    var previousPath = acc[acc.length - 1];
    var combined = "".concat(previousPath || '').concat(fragment);
    return [].concat(_toConsumableArray(acc), [combined]);
  }, []);
};

var consolidateTrails = function consolidateTrails() {
  var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var pathTrail = arguments.length > 1 ? arguments[1] : undefined;
  var modelTrail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var pathDepth = path.split('/').length;
  var longest = pathTrail.length > modelTrail.length ? pathTrail : modelTrail;
  var result = longest.reduce(function (acc, p, i) {
    var pathTrailIndex = acc.pathTrailIndex,
        foundMatch = acc.foundMatch,
        invalidate = acc.invalidate,
        foundMatchDepth = acc.foundMatchDepth;

    if (invalidate) {
      return acc;
    }

    var pathTrailPath = pathTrail[pathTrailIndex];
    var modelPath = modelTrail[i] || ''; // Path trail matches model: foundMatch

    if (pathTrailPath === modelPath) {
      return _objectSpread(_objectSpread({}, acc), {}, {
        foundMatch: true,
        pathTrailIndex: pathTrailIndex + 1,
        paths: [].concat(_toConsumableArray(acc.paths), [pathTrailPath])
      });
    ...
    var modelPathDepth = modelPath.split('/').length; // When a match was found, copy deeper levels from the model path
    // as long as the start of these pathss match the input path.

    if (foundMatch && modelPathDepth >= foundMatchDepth && new RegExp("^".concat(path, "[\\/$]")).test(modelPath)) {
      return _objectSpread(_objectSpread({}, acc), {}, {
        paths: [].concat(_toConsumableArray(acc.paths), [modelPath])
      });
...
var createLocationsFromPath = function createLocationsFromPath() {
  var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var modelTrail = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var pathTrail = pathToTrail(path);
...
/***/ "../../glissando-mithril/dist/glissando-mithril.module.js":
/*!****************************************************************!*\
  !*** ../../glissando-mithril/dist/glissando-mithril.module.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSliderStyle": function() { return /* reexport safe */ glissando__WEBPACK_IMPORTED_MODULE_0__.getSliderStyle; },
/* harmony export */   "GlissandoModel": function() { return /* reexport safe */ glissando__WEBPACK_IMPORTED_MODULE_0__.GlissandoModel; },
...
/* harmony export */ });
/* harmony import */ var glissando__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! glissando */ "../../glissando/dist/glissando.module.js");
...
var GlissandoSlider = function GlissandoSlider(initialVnode) {
  ...
  return {
    ...
    view: function view(_ref2) {
      ...
      var sliderClassName = attrs.className;

      var _getSliderStyle = (0,glissando__WEBPACK_IMPORTED_MODULE_0__.getSliderStyle)(getState()),
      ...
      }, mithril__WEBPACK_IMPORTED_MODULE_1___default()('.glissando-slider', {
...
var useGlissandoModel = function useGlissandoModel(initialState) {
  var model = (0,glissando__WEBPACK_IMPORTED_MODULE_0__.GlissandoModel)(initialState); // Subscribe to changes

  model.getState.map((mithril__WEBPACK_IMPORTED_MODULE_1___default().redraw));
  return model;
};
...
/***/ "../../glissando/dist/glissando.module.js":
/*!************************************************!*\
  !*** ../../glissando/dist/glissando.module.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var getInitialState = function getInitialState() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$sideViews = _ref.sideViews,
      sideViews = _ref$sideViews === void 0 ? 1 : _ref$sideViews,
...
var GlissandoModel = function GlissandoModel() {
    ...
    selectors: function selectors(states) {
      return {
        ...
        getViewIndices: function getViewIndices() {
          var state = states();
          return state.slots.map(function (slotIndex) {
  ...
  var states = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().scan(function (state, patch) {
    return patch(state);
  }, _objectSpread({}, glissandoState.initialState), update); // Debugging:
  ...
  var changedStates = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().scan(function (state, value) {
    return JSON.stringify(state, null, 2) === JSON.stringify(value, null, 2) ? (mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().SKIP) : value;
  }, (mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().SKIP), states);
  var getChanges = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().lift(function (value) {
    return value;
  }, changedStates);
...
var getSliderStyle = function getSliderStyle(state) {
  ...
  var style = _objectSpread({
    width: "calc(".concat(slotCount, " * calc(100%))"),
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*:focus {\n  outline: none;\n}\n\n.glissando-page {\n  position: relative; /* required for Ratchet layout of content */\n}\n\n.content {\n  width: 100%;\n}\n\n.user-page {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.user-first-letter {\n  text-decoration: none;\n  display: block;\n  font-size: 320px;\n  line-height: 1;\n  margin: 0;\n  color: #ddd;\n}\n\n.details {\n  padding: 20px;\n  color: #999;\n}\n\n.bar {\n  position: absolute;\n}\n\n.status {\n  margin-top: 44px;\n  padding: 10px 15px;\n  background: rgba(247, 247, 247, 0.98);\n  font-size: 14px;\n  color: #999;\n}\n", "",{"version":3,"sources":["webpack://./styles.css"],"names":[],"mappings":"AAAA;EACE,aAAa;AACf;;AAEA;EACE,kBAAkB,EAAE,2CAA2C;AACjE;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,qBAAqB;EACrB,cAAc;EACd,gBAAgB;EAChB,cAAc;EACd,SAAS;EACT,WAAW;AACb;;AAEA;EACE,aAAa;EACb,WAAW;AACb;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,qCAAqC;EACrC,eAAe;EACf,WAAW;AACb","sourcesContent":["*:focus {\n  outline: none;\n}\n\n.glissando-page {\n  position: relative; /* required for Ratchet layout of content */\n}\n\n.content {\n  width: 100%;\n}\n\n.user-page {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.user-first-letter {\n  text-decoration: none;\n  display: block;\n  font-size: 320px;\n  line-height: 1;\n  margin: 0;\n  color: #ddd;\n}\n\n.details {\n  padding: 20px;\n  color: #999;\n}\n\n.bar {\n  position: absolute;\n}\n\n.status {\n  margin-top: 44px;\n  padding: 10px 15px;\n  background: rgba(247, 247, 247, 0.98);\n  font-size: 14px;\n  color: #999;\n}\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".glissando{-ms-overflow-style:none;height:100%;overflow-x:hidden;-ms-overflow-y:scroll;width:100%}.glissando-slider{animation-timing-function:ease-in-out;display:flex;height:100%;transition-duration:.3s}.glissando-slider.glissando-animating{pointer-events:none}.glissando-page{-ms-overflow-style:auto;height:100%;overflow-y:auto;width:100%}", "",{"version":3,"sources":["webpack://./../../glissando-mithril/dist/glissando.min.css"],"names":[],"mappings":"AAAA,WAAW,uBAAuB,CAAC,WAAW,CAAC,iBAAiB,CAAC,qBAAqB,CAAC,UAAU,CAAC,kBAAkB,qCAAqC,CAAC,YAAY,CAAC,WAAW,CAAC,uBAAuB,CAAC,sCAAsC,mBAAmB,CAAC,gBAAgB,uBAAuB,CAAC,WAAW,CAAC,eAAe,CAAC,UAAU","sourcesContent":[".glissando{-ms-overflow-style:none;height:100%;overflow-x:hidden;-ms-overflow-y:scroll;width:100%}.glissando-slider{animation-timing-function:ease-in-out;display:flex;height:100%;transition-duration:.3s}.glissando-slider.glissando-animating{pointer-events:none}.glissando-page{-ms-overflow-style:auto;height:100%;overflow-y:auto;width:100%}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
/* harmony export */ });
/* harmony import */ var glissando_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! glissando-helpers */ "../../glissando-helpers/dist/glissando-helpers.module.js");
/* harmony import */ var glissando_mithril__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! glissando-mithril */ "../../glissando-mithril/dist/glissando-mithril.module.js");
...
/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Header */ "./Header.ts");
/* harmony import */ var _Listing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Listing */ "./Listing.ts");
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./User */ "./User.ts");
/* harmony import */ var _UserDetails__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./UserDetails */ "./UserDetails.ts");
/* harmony import */ var _users__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./users */ "./users.ts");
...
var Slider = function () {
    ...
    return {
        view: function (_a) {
            ...
            if (mithril__WEBPACK_IMPORTED_MODULE_2___default().route.param('user')) {
                localState.user = mithril__WEBPACK_IMPORTED_MODULE_2___default().route.param('user');
            }
            var location = mithril__WEBPACK_IMPORTED_MODULE_2___default().route.get();
            var locations = (0,glissando_helpers__WEBPACK_IMPORTED_MODULE_0__.createLocationsFromPath)(location, model.getState().locations);
            return mithril__WEBPACK_IMPORTED_MODULE_2___default()(glissando_mithril__WEBPACK_IMPORTED_MODULE_1__.GlissandoSlider, {
                model: model,
                locations: locations,
                location: location,
            }, locations.map(function (_, index) {
                switch (index) {
                    case 0:
                        return mithril__WEBPACK_IMPORTED_MODULE_2___default()(_Listing__WEBPACK_IMPORTED_MODULE_4__.Listing, { users: _users__WEBPACK_IMPORTED_MODULE_7__.default });
                    case 1:
                        return mithril__WEBPACK_IMPORTED_MODULE_2___default()(_User__WEBPACK_IMPORTED_MODULE_5__.User, {
                            user: localState.user,
                        });
                    case 2:
                        return mithril__WEBPACK_IMPORTED_MODULE_2___default()(_UserDetails__WEBPACK_IMPORTED_MODULE_6__.UserDetails, {
                            user: localState.user,
                        });
                    default:
                        return null;
...
var App = function () {
    var model = (0,glissando_mithril__WEBPACK_IMPORTED_MODULE_1__.useGlissandoModel)();
    return {
        view: function () { return [mithril__WEBPACK_IMPORTED_MODULE_2___default()(_Header__WEBPACK_IMPORTED_MODULE_3__.Header, { model: model }), mithril__WEBPACK_IMPORTED_MODULE_2___default()(Slider, { model: model })]; },
    };
};
...
var Header = {
    view: function (_a) {
        var attrs = _a.attrs;
        var model = attrs.model;
        var isAnimating = model.isAnimating, getLocation = model.getLocation, getPreviousLocation = model.getPreviousLocation;
        var location = getLocation();
        var previousLocation = getPreviousLocation();
        var goPrevious = function () {
            if (previousLocation) {
                mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set(previousLocation);
            }
        };
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().fragment({}, [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('header', {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                    ...
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', 'Back'),
                ]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('h1', {
                    className: 'title',
                }, location),
            ]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('.status', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', "locations: " + JSON.stringify(model.getState().locations || [])),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', "location: \"" + model.getState().location + "\""),
            ]),
        ]);
    },
};
...
var Listing = {
    view: function (_a) {
        ...
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', mithril__WEBPACK_IMPORTED_MODULE_0___default()('ul.table-view', users.map(function (name) {
            var personRoute = "/users/" + name;
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('li.table-view-cell media', mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                href: personRoute,
...
var User = {
    view: function (_a) {
        var attrs = _a.attrs;
        var user = attrs.user;
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', user &&
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('.user-page', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.user-first-letter', user[0]),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "UserDetails": function() { return /* binding */ UserDetails; }
/* harmony export */ });
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
...
if (rootElement) {
    mithril__WEBPACK_IMPORTED_MODULE_2___default().route(document.body, '/users', {
        '/users': _App__WEBPACK_IMPORTED_MODULE_3__.App,
        '/users/:user': _App__WEBPACK_IMPORTED_MODULE_3__.App,
        '/users/:user/details': _App__WEBPACK_IMPORTED_MODULE_3__.App,
    });
}
