...
var Slider = {
    view: function (_a) {
        ...
        var currentPage = mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.param('page');
...
var Header = {
    view: function (_a) {
        ...
        var goNext = function () {
            if (nextLocation) {
                mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.set(nextLocation);
            }
        };
...
if (rootElement) {
    mithril__WEBPACK_IMPORTED_MODULE_2___default.a.route(document.body, '/', {
        '/': {
            onmatch: function () {
                mithril__WEBPACK_IMPORTED_MODULE_2___default.a.route.set('/1');
            },
        },
