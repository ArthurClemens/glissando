...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body,\nhtml {\n  margin: 0;\n}\n\nbody {\n  font-family: sans-serif;\n}\n\n.demo-container {\n  width: 375px;\n  margin: 0 auto;\n}\n\n.row {\n  display: flex;\n  padding: 20px 0;\n  border-bottom: 1px solid #ddd;\n}\n\n.row > * + * {\n  margin-left: 10px;\n}\n\n.demo-page {\n  background: #efefef;\n  max-height: 300px; /* demonstrate scrolling */\n  overflow: auto;\n  font-size: 18px;\n}\n\n.demo-page .top {\n  padding: 15px;\n}\n\n.demo-page img {\n  width: 100%;\n}\n", "",{"version":3,"sources":["webpack://./styles.css"],"names":[],"mappings":"AAAA;;EAEE,SAAS;AACX;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,6BAA6B;AAC/B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,mBAAmB;EACnB,iBAAiB,EAAE,0BAA0B;EAC7C,cAAc;EACd,eAAe;AACjB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,WAAW;AACb","sourcesContent":["body,\nhtml {\n  margin: 0;\n}\n\nbody {\n  font-family: sans-serif;\n}\n\n.demo-container {\n  width: 375px;\n  margin: 0 auto;\n}\n\n.row {\n  display: flex;\n  padding: 20px 0;\n  border-bottom: 1px solid #ddd;\n}\n\n.row > * + * {\n  margin-left: 10px;\n}\n\n.demo-page {\n  background: #efefef;\n  max-height: 300px; /* demonstrate scrolling */\n  overflow: auto;\n  font-size: 18px;\n}\n\n.demo-page .top {\n  padding: 15px;\n}\n\n.demo-page img {\n  width: 100%;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var glissando_mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! glissando-mithril */ "../../glissando-mithril/dist/glissando-mithril.module.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _Page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Page */ "./Page.ts");
...
var Slider = function () {
    var model = (0,glissando_mithril__WEBPACK_IMPORTED_MODULE_0__.useGlissandoModel)();
    var appModel = (0,_AppModel__WEBPACK_IMPORTED_MODULE_2__.AppModel)({
        isAnimated: true,
        isRtl: false,
        count: 5,
        selectIndices: [],
    ...
    return {
        view: function () {
            ...
            var pagesList = __spreadArray([], Array(pageCount)).map(function (_, i) { return i; });
            return mithril__WEBPACK_IMPORTED_MODULE_1___default()('.demo-container', {
                dir: appModel.getState().isRtl ? 'rtl' : '',
            }, [
                mithril__WEBPACK_IMPORTED_MODULE_1___default()(_Header__WEBPACK_IMPORTED_MODULE_3__.Header, { model: model, appModel: appModel }),
                mithril__WEBPACK_IMPORTED_MODULE_1___default()(glissando_mithril__WEBPACK_IMPORTED_MODULE_0__.GlissandoSlider, {
                    model: model,
                }, pagesList.map(function (index) { return mithril__WEBPACK_IMPORTED_MODULE_1___default()(_Page__WEBPACK_IMPORTED_MODULE_4__.Page, { key: index, index: index }); })),
            ]);
        },
    };
};
var App = function () { return ({
    view: function () { return mithril__WEBPACK_IMPORTED_MODULE_1___default()(Slider); },
}); };
...
var createSelectIndices = function (count) {
    return __spreadArray([], Array(count)).map(function (_, i) { return i; });
};
var AppModel = function (props) {
    ...
    var appState = {
        initialState: initialState,
        actions: function (update) { return ({
            setIsAnimated: function (isAnimated) {
                update(function (state) { return (__assign(__assign({}, state), { isAnimated: isAnimated })); });
            },
            setIsRtl: function (isRtl) {
                update(function (state) { return (__assign(__assign({}, state), { isRtl: isRtl })); });
            },
            setCount: function (count) {
                update(function (state) { return (__assign(__assign({}, state), { count: count, selectIndices: createSelectIndices(count) })); });
            },
        }); },
    };
    var update = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default()();
    var states = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().scan(function (state, patch) { return patch(state); }, __assign({}, appState.initialState), update);
    ...
    var getChanges = mithril_stream__WEBPACK_IMPORTED_MODULE_0___default().lift(function (value) { return value; }, changedStates);
...
var Header = {
    view: function (_a) {
        var attrs = _a.attrs;
        var appModel = attrs.appModel, model = attrs.model;
        ...
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('header', [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('.row.row-meta', [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('.row.row-controls', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                    onclick: function () { return next({ animate: appModel.getState().isAnimated }); },
...
var Page = {
    view: function (_a) {
        var attrs = _a.attrs;
        var imageId = attrs.index + 1;
        var imageName = "" + (imageId < 10 ? '0' : '') + imageId;
        var imageUrl = "https://arthurclemens.github.io/assets/mithril-slider/img/" + imageName + ".jpg";
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.demo-page', mithril__WEBPACK_IMPORTED_MODULE_0___default()('img', {
            src: imageUrl,
        }));
    },
};
...
if (rootElement) {
    mithril__WEBPACK_IMPORTED_MODULE_2___default().mount(rootElement, _App__WEBPACK_IMPORTED_MODULE_3__.App);
}
