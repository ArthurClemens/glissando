...
var Slider = {
    view: function (_a) {
        ...
        var currentPage = mithril__WEBPACK_IMPORTED_MODULE_1___default().route.param('page');
        return mithril__WEBPACK_IMPORTED_MODULE_1___default()(glissando_mithril__WEBPACK_IMPORTED_MODULE_0__.GlissandoSlider, {
            ...
            return mithril__WEBPACK_IMPORTED_MODULE_1___default()(_Page__WEBPACK_IMPORTED_MODULE_3__.Page, {
                key: id,
                location: id,
            });
        }));
...
var Header = {
    view: function (_a) {
        ...
        var goNext = function () {
            if (nextLocation) {
                mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set(nextLocation);
            }
        };
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('header', {
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', 'Previous'),
            ]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                type: 'button',
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', 'Next'),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', {
...
if (rootElement) {
    mithril__WEBPACK_IMPORTED_MODULE_2___default().route(document.body, '/', {
        '/': {
            onmatch: function () {
                mithril__WEBPACK_IMPORTED_MODULE_2___default().route.set('/1');
            },
        },
        '/:page': _App__WEBPACK_IMPORTED_MODULE_3__.App,
    });
}
